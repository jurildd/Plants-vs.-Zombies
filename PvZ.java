...
public class PvZ {
    ...
    public void simulateGame() {
        ...
        producers = getProducerPlants();
        for (Producer chr : producers) {
           sunlight += chr.produce();
        }
        ...
        // Plant deal damage to first zombie on the same row
        ...
        // SplashAttacker Plant deal damage to surrounding zombies
